 ...
 * ClinicServiceSpringDataJpaTests#clinicService clinicService}</code> instance
...
public class ClinicServiceSpringDataJpaTests {
	...
	public void shouldAddNewVisitForPet() {
		...
		visit.setDate(new LocalDate());
		visit.setAppointmentStart(new LocalDateTime());
		visit.setAppointmentEnd(new LocalDateTime().plusHours(1));
		Collection<Vet> vets = this.clinicService.findVets();
		visit.setVet(EntityUtils.getById(vets, Vet.class, 3));
		pet7.addVisit(visit);
